...
import ClassReportPage from './Components/Teacher/Classes/ClassReportPage';
...
/>} /> 
        ...
        <>
        {
          ...
          <> 
            ...
            <Route path="/teacher/classes/:classId/report" element={<ClassReportPage onLogout={handleLogout} />} />
